...
class WP206SameRefMutatedEvidenceFalsifier(unittest.TestCase):
    ...
    def test_same_ref_cannot_observe_mutated_external_evidence_bytes(self) -> None:
        ...
        try:
            ...
            # Mutate the external evidence object without changing the provenance label.
            ...
            # Executable counterexample predicate: G4 sees only identical ref text, so the
            # changed external evidence subject remains unobservable at this boundary.
