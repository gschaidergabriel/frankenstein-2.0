...
def test_pr307_rejects_positive_uptake_without_typed_downstream_lineage_closure():
    ...
    # The exact accepted WP507/WP508 component objects preserve the caller-supplied
    # downstream identity, but the WP510 bundle carries no concrete downstream output
    # that can be revalidated against bundle.cell_input.
    ...
    # Preregistered WP510 integration requirement: a positive causal-path seal must not
    # be minted from an unresolved downstream ref/digest alone.
