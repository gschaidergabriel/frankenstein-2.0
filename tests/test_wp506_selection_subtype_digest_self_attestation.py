...
class SelfAttestingWorkspaceSelection(WorkspaceSelection):
    """Canonical regression for REVIEW_ONLY PR #267."""
...
def make_plan() -> Grid10Plan:
    return Grid10Plan.create(
        plan_id="grid-plan-review-wp506-g3-selection-subtype",
        cycle_id="cycle-review-wp506-g3-selection-subtype",
        generation=4,
        frame_id="frame-review-wp506-g3-selection-subtype",
        frame_generation=5,
        frame_sha256=A,
        policy_id="grid-policy-review-wp506-g3-selection-subtype",
        policy_generation=1,
        policy_sha256=B,
        cells=tuple(
            CellBudget(
        ...
        provenance_refs=("prov:grid-plan-review-wp506-g3",),
    )
...
def make_selection(plan: Grid10Plan) -> WorkspaceSelection:
    ...
    candidate = WorkspaceCandidate(
        candidate_id="candidate:review-wp506-g3-selection-subtype",
    ...
    policy = SelectionPolicy(
        policy_id="gwt-policy-review-wp506-g3-selection-subtype",
        generation=1,
    ...
    return build_workspace_selection(
        selection_id="selection:review-wp506-g3-selection-subtype",
...
def test_create_broadcast_rejects_digest_self_attesting_subtype():
    ...
    with pytest.raises(GwtWorkspaceError, match="concrete WorkspaceSelection"):
        create_broadcast(
            broadcast_id="broadcast:review-wp506-g3-selection-subtype",
            generation=3,
