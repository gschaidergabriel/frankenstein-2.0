...
verdict: a legitimate WP103 commit on another connection changes it without mutating WP206.
G6 therefore uses data_version only as a dirty hint and must fail closed only when bounded
revalidation shows that the WP206-owned checkpoint surface changed.
