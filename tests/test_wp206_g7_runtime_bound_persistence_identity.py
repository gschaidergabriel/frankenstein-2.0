"""WP206 G8 regression for WP900 G5 -> WP206 runtime identity persistence.

Absorbed from the validated REVIEW_ONLY PR #940 under the current WP206 G8 mutation
authority. The historical seal-only adapter cannot distinguish valid G5 runtime subjects
that share one deterministic whole-loop seal; this regression requires the existing
canonical WP206 store to preserve their distinct runtime/source identity without creating
