...
def test_selected_candidate_subtype_attribute_lineage_split_fails_closed():
    ...
    class ForgedSelectedCandidate(SelectedCandidate):
        def as_dict(self):
            ...
            payload["payload_ref"] = original.payload_ref
            return payload
    ...
    assert forged_item.as_dict()["payload_ref"] == original.payload_ref
