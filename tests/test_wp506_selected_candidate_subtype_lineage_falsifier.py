"""Canonical regression absorbed from REVIEW_ONLY PR #274 for F2-WP-506 generation 3.

The regression preserves the adversarial construction so the consuming WP506 lineage gate,
not object construction, must reject a SelectedCandidate subtype whose canonical serialization
differs from attributes later consumed into BroadcastEnvelope.
"""
...
class ForgedSelectedCandidate(SelectedCandidate):
    """Expose a forged direct payload_ref while self-reporting canonical lineage."""
