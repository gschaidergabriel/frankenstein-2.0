...
Frankenstein 2.0 includes the Perception Fabric defined in `architecture/PERCEPTION_FABRIC.md` and hardened by `architecture/PERCEPTION_FABRIC_HARDENING_20260829.md`.
